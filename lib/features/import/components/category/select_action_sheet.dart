      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            "привязаны к предустановленной.\n\nНапример, если у тебя была "
            'категория "Покупки из магазина", и ты выберешь предустановленную '
            'категорию "Продукты", то после импорта у транзакций категория '
            'будет называться "Продукты".\n\nЕсли не хочешь привязывать, можно '
