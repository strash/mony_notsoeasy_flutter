...
enum EImportColumn implements IDescriptable {
  ...
  String get description {
    return switch (this) {
      ...
      EImportColumn.date => "Это обязательная колонка и она должна содержать "
      ...
      EImportColumn.category => "В этой колонке должен быть обычный текст, "
          ...
          "запятых.",
      EImportColumn.tag => "В этой колонке должен быть обычный текст, "
          "скорее всего состоящий из одного слова. В некоторых транзакциях она "
          "может быть пустой, так как необязательна. Тег это что-то вроде "
          "подгатегории. Текст в нем не должен содержать запятых.",
      EImportColumn.note => "В этой колонке может быть обычный текст, "
