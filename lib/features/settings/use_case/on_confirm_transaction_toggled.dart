...
final class OnConfirmTransactionToggled extends UseCase<Future<void>, dynamic> {
  @override
  Future<void> call(BuildContext context, [_]) async {
    final sharedPrefService = context.read<DomainSharedPreferencesService>();
    final viewModel = context.viewModel<SettingsViewModel>();

    final currValue = await sharedPrefService.getSettingsConfirmTransaction();
    final value = !currValue;

    await sharedPrefService.setSettingsConfirmTransaction(value);

    viewModel.setProtectedState(() {
      viewModel.confirmTransaction = value;
    });
  }
}
