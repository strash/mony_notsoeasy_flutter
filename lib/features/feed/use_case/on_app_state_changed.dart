...
// TODO: 1. Если проскролить ленту вниз на несколько страниц и обновить счет, то
// поидеи нужно загрузить снова все эти страницы, либо сбрасывать позицию скрола
// экрана. Сейчас только первая страница подгружается
